...
Por fim, o empréstimo digital nas bibliotecas municipais portuguesas. Há concelhos com integração funcional via OverDrive / Libby, que dá par com a Kobo. O lado Kindle não tem equivalência prática (o sistema Amazon foi pensado para mercados anglófonos e não chegou a Portugal com a mesma robustez). Para quem usa a biblioteca pública com regularidade, este ponto é por si só decisivo.
