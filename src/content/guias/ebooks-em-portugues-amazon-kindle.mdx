...
<div class="my-6 grid grid-cols-3 gap-4">
  ...
  <ImagemProduto asin="B0CGVSKR1G" alt="Kindle Colorsoft — para banda desenhada e ilustrados" marketplace="es" formato="pequeno" />
  <ImagemProduto asin="B0DVQQGMCZ" alt="Kindle Scribe — para PDFs académicos em português" marketplace="es" formato="pequeno" />
</div>
...
2. Remover o DRM (para uso pessoal) e converter para Kindle com [Calibre](https://calibre-ebook.com). É zona cinzenta legal — permitido em vários países para cópia pessoal, ilegal para distribuição.
